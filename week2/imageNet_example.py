...
net = caffe.Classifier(MODEL_FILE, PRETRAINED,
		       ...
		       channel_swap=(2,1,0),             
                       ...
                       image_dims=(256, 256))
for i in range(1, 9):                     
    IMAGE_FILE = '/usr/prakt/p041/OzgeAkin/MachineLearningPraktikum/week2/ex2_images/IMG_'+str(i)+'.jpg'
    ...
    out = net.forward()
    print 'softmax probability: ', round(out['prob'][0][predicted_class],2)
